"""
Modified from https://github.com/pytorch/vision/blob/master/torchvision/models/ResNetGN.py
"""
...
def ResNetGN34(num_classes=10):
    return ResNetGN(BasicBlockGN, [3, 4, 6, 3], num_classes=num_classes)


def ResNetGN50(num_classes=10):
    return ResNetGN(BottleneckGN, [3, 4, 6, 3], num_classes=num_classes)


def ResNetGN101(num_classes=10):
    return ResNetGN(BottleneckGN, [3, 4, 23, 3], num_classes=num_classes)


def ResNetGN152(num_classes=10):
    return ResNetGN(BottleneckGN, [3, 8, 36, 3], num_classes=num_classes)
